...
export const render = ({ daysLived, daysLeft, percentLeft }) => (
  <div>
    <Context>
      ...
      <Row>
        <Title>Left:</Title> <Value>{daysLeft}</Value>
      </Row>
    </Context>
  </div>
);
...
const calculateTime = () => {
  ...
  return {
    daysLived: `${lived.days} Days (${lived.hours}:${lived.minutes}:${lived.seconds})`,
    daysLeft: `${left.days} Days (${left.hours}:${left.minutes}:${left.seconds})`,
    percentLeft,
  };
};
